        ...
        <script>
            ...
            function showPlanAttemptModal(taskId, data) {
                ...
                if (data.error) {
                    ...
                    var d = document.createElement('div');
                    d.className = 'text-sm text-gray-400 flex items-center gap-2 border-t border-gray-700 pt-2 mt-2';
                    d.innerHTML = '<i class="fab fa-algolia"></i> WIP count: ' + wipTxt + ', Awards: ' + awardTxt;
                    warningsContainer.appendChild(d);
                }
